<%-- 
    Document   : search
    Created on : Mar 14, 2023, 9:58:33 PM
    Author     : trant
--%>


<%--<%@page import="trantri.registration.RegistrationDTO"%>
...
<html>
    ...
    <body>
        ...
        <c:if test="${not empty searchValue}">
              <c:set var="result" value="${requestScope.RESULT_PAGE}"/>
        </c:if>
         ...
         <%
          ...
          if(searchValue!= null){
              List<RegistrationDTO> result = (List<RegistrationDTO>)
                      request.getAttribute("RESULT_PAGE");
              if(result!= null){
                 %>
                 <table border="1">
                     <thead>
